...
- [ ] Confirmed schema and type shapes before editing structured payloads
- [ ] Kept the PR scoped to the ticket without unrelated refactors, style sweeps, or whitespace churn
