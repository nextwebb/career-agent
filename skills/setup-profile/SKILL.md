---
description: Build profile.json from your CV or LinkedIn PDF — extracts work history, generates 3 CV variants, writes per-job bullets automatically
---

# setup-profile

Bootstrap `profile.json` from a CV, resume, or LinkedIn PDF export. Extracts your work history, infers three audience-specific CV variants (AI/LLM, Data Platform, Backend), and writes every bullet three ways — so you are ready to generate tailored applications immediately.
...
No argument required — Claude accepts a file upload or pasted text in the same message.
...
4. **Nothing provided** — Claude asks: "Please paste your CV text or upload your CV/LinkedIn PDF and I'll build your profile.json."
